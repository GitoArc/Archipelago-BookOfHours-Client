...
// shamelessly stolen from bepinex templates https://github.com/alwaysintreble/ArchipelagoBepInExPluginTemplate/blob/master/templates/ArchipelagoBepin5Template/Utils/ArchipelagoConsole.cs
public static class ArchipelagoConsole
{
    ...
    public static void OnGUI()
    {
        ...
        {
            Mod.ArchipelagoClient.SendMessage(CommandText);
            CommandText = "";
        }
    }
